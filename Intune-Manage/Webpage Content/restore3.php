...
<form action="process.php" method="post">
    ...
    <button type="button" onclick="checkAll()" class="button">Check All</button>
    <button type="button" onclick="uncheckAll()" class="button">Uncheck All</button>
    <tr><td colspan="3"><label for="checkbox">Also restore assignments?:</label>
    <input type="checkbox" id="checkbox" name="assignment"></td></tr>
    <tr><td colspan="3"><label for="checkbox">Create groups if they don't exist?:</label>
    <input type="checkbox" id="checkbox" name="groupcreate"></td></tr>
    <?php
//Check if $desttenant is set
if (empty($_POST['desttenant'])) {
...
echo "<select name='tenantid[]' multiple>";
...
if (isset($policy['value'][3][0])) {
  ...
  ?>
    <td>
    <input class="profile-btn" type="submit" value="Restore"></td></tr>
    </form>
    </table>
